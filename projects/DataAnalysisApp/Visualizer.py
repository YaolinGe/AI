...
class Visualizer:
    ...
    #
    #             if incut:
    #                 incut_regions = df['incut'].index
    #                 for start, end in zip(incut_regions[:-1], incut_regions[1:]):
    #                     print("Start: ", start, "End: ", end)
    #                     if end - start > 1:
    #                         ax.axvspan(df[timestamp_col].iloc[start], df[timestamp_col].iloc[end], color='red', alpha=0.2)
    #
